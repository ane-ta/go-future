workspace "GoFuture" "Полная модель текущего состояния (As-Is)" {
    ...
    model {
        ...
        goFuture = softwareSystem "GoFuture Platform" {
            ...
            grafana = container "Grafana" "Визуализация метрик. Дашборды"  " " "Observability"
            alertManager = container "Alertmanager" "Алертинг"  " "  "Observability"
            loki = container "Loki" "Сбор логов"  " " "Observability"        
